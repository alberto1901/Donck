...
##
## Modified for statenjach Adriaen van shader Donck by Jeffery S. Koppe
...
var _Donck_initialized = 0;
setlistener("/sim/signals/fdm-initialized", func {
    if (_Donck_initialized) return;
    aircraft.livery.init("Aircraft/Donck/Models/Liveries");
    settimer(ground, 0.0);
    print("Hydrodynamics initialized.");
    _Donck_initialized = 1;
});
